...
% 1st. author
\alignauthor
Nicholas Robinson\\ %\titlenote{Dr.~Trovato insisted his name be first.}\\
...
%% 2nd. author
\alignauthor
Sam McNaughton\\ %\titlenote{The secretary disavows
...
\parbox{0.499\textwidth}{\centering
   {\small 2-D}\\
   \input{\bbobdatapath\algfolder pptable_02D_noiselessall}}%
\parbox{0.499\textwidth}{\centering
   {\small 5-D}\\
...
\rot{separable fcts}
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_02D_separ} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_02D_separ} &
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_05D_separ} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_05D_separ} \\[-2ex]
\rot[1]{misc.\ moderate fcts}
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_02D_lcond} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_02D_lcond} &
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_05D_lcond} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_05D_lcond} \\[-2ex]
\rot[1.3]{ill-conditioned fcts}
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_02D_hcond} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_02D_hcond} &
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_05D_hcond} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_05D_hcond} \\[-2ex]
\rot[1.6]{multi-modal fcts}
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_02D_multi} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_02D_multi} &
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_05D_multi} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_05D_multi} \\[-2ex]
\rot[1.0]{weak structure fcts}
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_02D_mult2} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_02D_mult2} &
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_05D_mult2} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_05D_mult2}\\[-2ex]
\rot{all functions}
\includegraphics[width=0.268\textwidth,trim=0 0 0 13mm, clip]{pprldistr_02D_noiselessall} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 13mm, clip]{ppfvdistr_02D_noiselessall} &
...
\begin{figure}
\centering
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_02D_noiselessall}% 
\includegraphics[width=0.24\textwidth,trim=7mm 0 9mm 12mm, clip]{pplogloss_05D_noiselessall}%
\\[-6.2ex]
\parbox{0.49\columnwidth}{\centering 2-D}%
\parbox{0.49\columnwidth}{\centering 5-D}\\[5ex]
%
\input{\bbobdatapath\algfolder pploglosstable_02D_noiselessall}\\
...
\rot{separable fcts}
\hspace*{-2mm}
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_02D_separ} &
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_03D_separ} &
\includegraphics[width=0.24\textwidth,trim=7mm 0 9mm 12mm, clip]{pplogloss_05D_separ}\\[-2ex]
\rot[2]{moderate fcts}
\hspace*{-2mm}
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_02D_lcond} &
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_03D_lcond} &
\includegraphics[width=0.24\textwidth,trim=7mm 0 9mm 12mm, clip]{pplogloss_05D_lcond}\\[-2ex]
\rot[1.3]{ill-conditioned fcts}
\hspace*{-2mm}
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_02D_hcond} &
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_03D_hcond} &
\includegraphics[width=0.24\textwidth,trim=7mm 0 9mm 12mm, clip]{pplogloss_05D_hcond}\\[-2ex]
\rot[1.6]{multi-modal fcts}
\hspace*{-2mm}
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_02D_multi} &
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_03D_multi} &
\includegraphics[width=0.24\textwidth,trim=7mm 0 9mm 12mm, clip]{pplogloss_05D_multi}\\[-2ex]
\rot[1.0]{weak structure fcts}
\hspace*{-2mm}
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_02D_mult2} &
\includegraphics[width=0.24\textwidth,trim=0 0 16mm 12mm, clip]{pplogloss_03D_mult2} &
\includegraphics[width=0.24\textwidth,trim=7mm 0 9mm 12mm, clip]{pplogloss_05D_mult2}
\vspace*{-0.5ex}
\end{tabular}
